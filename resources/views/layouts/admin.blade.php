    ...
    <div class="flex-col w-full md:flex md:flex-row md:min-h-screen">
        <div @click.away="open = false"
            ...
            <div class="flex flex-row items-center justify-between flex-shrink-0 px-8 py-4">
                <a href="#"
                    class="text-lg font-semibold tracking-widest text-gray-900 uppercase rounded-lg dark:text-white focus:outline-none focus:shadow-outline">ROLE & PERMISSION</a>
            ...
            <nav :class="{'block': open, 'hidden': !open}"
                ...
                <x-admin-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">Back to Home
                </x-admin-link>
                <x-admin-link :href="route('admin.index')" :active="request()->routeIs('admin.index')">Admin Portal
                </x-admin-link>
